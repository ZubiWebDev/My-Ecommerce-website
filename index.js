...
function getAllProducts() {
  let mappedData = ecomData.products
    .map(
      (meriProduct) => ` <div class="card">
    <img src=${meriProduct.images[0]} alt="product" />
          <div class="category">${meriProduct.category}</div>
          <div class="product-header">
          <h3>${meriProduct.title}</h3>
          <div class="price">$${meriProduct.price}</div>
          </div>
          <div class="product-body">
          <p>
            ${meriProduct.description}
            </p>
          </div>
  ...
  cards.innerHTML = mappedData;
}
getAllProducts();

function getProductsByCategory(category) {
  let filteredProducts = ecomData.products.filter(
    (meriProduct) => meriProduct.category === category
  );
